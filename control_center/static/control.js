                ...
                axios
                    ...
                    .then(function (response) {
                        ...
                        for (i = 0; i < num_of_custom_animations; i++) {
                            control_object.main_window_new_html += '<option data-based-on="'+('based_on' in led_animations['led_animations']['custom'][i] ? led_animations['led_animations']['custom'][i]['based_on']:'')+'" data-customization="'+JSON.stringify(led_animations['led_animations']['custom'][i]['customization']).replaceAll('"',"'")+'" value="' + led_animations['led_animations']['custom'][i]['id'] + '"'
                        ...
                        for (i = 0; i < num_of_default_animations; i++) {
                            ...
                            if (led_animations['led_animations']['default'][i]['id'] != "0000000000") {
                                control_object.main_window_new_html += '<option data-customization="'+('customization' in led_animations['led_animations']['default'][i]? JSON.stringify(led_animations['led_animations']['default'][i]['customization']).replaceAll('"',"'"):'')+'" value="' + led_animations['led_animations']['default'][i]['id'] + '"'
                                // mark mode as selected if thats the case in "current mix"
