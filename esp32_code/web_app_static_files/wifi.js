        ...
        axios
            ...
            .then(function(response){
                ...
                if (response.data.networks[0].current_wifi==false || response.data.networks[0].is_default_wifi==true){
                    ...
                    for (this.i = 0; this.i < response.data.networks.length; this.i++) {
                        self.network = response.data.networks[this.i];
                        self.cta = 'connect';
        ...
        if (essid!=null){
            ...
            axios
                .post('/connect_to_wifi_all_led_strips',{
                    'essid':essid,
                    'password':password, // TODO yeah yeah, this.i know. Don't worry, password will be submitted only if you are on the "TheGlowingStripes" wifi. And if anyone has a better suggestion on how to safely submit the wifi password on the local wifi without ssl issues, let me know
